...
public class SceneTemplateTesting extends SceneTemplate implements Screen {
    ...
    public SceneTemplateTesting(Projet5001 game){
    ...
    /**
     * Methode potentielle : setupACTEUR(S) , setupDIRECTORS, setupMAP, setupSPRITE , etc...
     */
    public void setup(){

        this.actors.add(myActor);
        this.directors.add(uiDirector);
        this.directors.add(worldDirector);

        SceneControls actualControl = controls.getInstance();

        actualControl.addControl(joyPadControleur);
        actualControl.addControl(Keyboard);
